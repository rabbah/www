  ...
  return `
    <div id="content">
      <div id="wsite-content" class="wsite-elements wsite-not-footer">
        ...
        <div class="paragraph">
          <span style="color:#3f3f3f !important;font-weight:bold">I am Dr. Rodric Rabbah and I am running for a 3-year term on the Somers Board of Education.</span>
        ...
        <div class="paragraph">
          <span style="color:#3f3f3f !important;font-weight:bold">I will bring a fresh perspective to the Board of Education, especially concerning STEAM education (Science, Technology, Engineering, the Arts and Mathematics).</span>
        ...
        <div class="paragraph">
          <span style="color:#3f3f3f !important;font-weight:bold">I am keenly interested in how our district is approaching STEAM readiness, and the curriculum changes that are being considered by the Superintendent.</span>
        ...
        <div class="paragraph">
          <span style="color:#3f3f3f !important;font-weight:bold">Of course changes take time, training and investment, and I am already committed for the entire journey.</span>
        ...
        <div class="paragraph">
          <span style="color:#3f3f3f !important;font-weight:bold">The pandemic has brought about new challenges and realities around distance learning for which I have real world expertise.</span>
        ...
        <div class="paragraph">
          <span style="color:#3f3f3f !important;font-weight:bold">I know that establishing distance learning programs requires unique technologies and integrations, for which I can offer first-hand experience based on running my fully remote company.</span>
        ...
        <div class="paragraph">
          <span style="color:#3f3f3f !important;font-weight:bold">In summary, my background, my unique perspectives, and my experience would be vital assets in addressing the challenges facing the district. I hope I have earned your vote for the privilege to represent you and your children on the School Board.</span>
          <br/>
        </div>
        ...
        <div id="info" class="paragraph">
          ...
          <ul>
            <li><span style="color:#3f3f3f !important;font-weight:bold">To contact me:</span> email me at <a href='mailto:rodric@gmail.com'>rodric@gmail.com</a> or call <a href='tel:+16462486456'>646-248-6456</a>.</li>
            <li><span style="color:#3f3f3f !important;font-weight:bold">To receive a paper ballot if one was not mailed to you:</span> email our District Clerk Nancy Corrado at <a href='mailto:ncorrado@somersschools.org'>ncorrado@somersschools.org</a>.</li>
            <li><span style="color:#3f3f3f !important;font-weight:bold">If you are not registered to vote:</span> visit <a href='https://dmv.ny.gov/more-info/electronic-voter-registration-application'> https://dmv.ny.gov/more-info/electronic-voter-registration-application</a> to register online.</li>
          </ul>
          <br/>
          Respectfully,<br/>
          Dr. Rodric Rabbah<br/>
